...
#ifndef SRC_TEMPERATURE_CONTROLLER_MODULE_H_
#define SRC_TEMPERATURE_CONTROLLER_MODULE_H_

#define UNIT_TESTING_ENABLED true
...
public:
	...
	bool getHeaterState(Heater *heater); // Mock interface
	void setHeaterState(Heater *heater, bool stateOn); // Mock interface
	void setHeaterTemperature(Heater *heater, int temp); // Mock interface
...
#endif /* SRC_TEMPERATURE_CONTROLLER_MODULE_H_ */
